...
import com.green.gittest.email.model.MailSendRes;
import com.green.gittest.email.model.RedisUtil;
...
public class MailSendService {
    ...
    public MailSendRes joinEmail(String email) {
        UserEntityEmail userEntityEmail = mapper.getUserByEmail(email);
        MailSendRes res = new MailSendRes();
        if (userEntityEmail != null) {
            res.setEmailCheckCode("이미 가입된 이메일입니다.");
            return res;
        } else try {
            makeRandomNumber();
            ...
            res.setEmailCheckCode(Integer.toString(authNumber));
            return res;
